(define (control-knowledge ck1) (:domain mais) (:problem p1)
	...
	(t-exists (?prepare_barb5p0 - (prepare_bar b5 p0)) 
		...
		(t-exists (?finish_barb5p3 - (finish_bar b5 p3)) 
		(and (= (- ?loadh0b5p0 ?prepare_barb5p0) 60)(>= (- ?loadh0b5p1 ?unloadh0b5p1) 10)(<= (- ?loadh0b5p1 ?unloadh0b5p1) 30)(>= (- ?loadh0b5p2 ?unloadh0b5p2) 10)(<= (- ?loadh0b5p2 ?unloadh0b5p2) 30)(= (- ?finish_barb5p3 ?unloadh0b5p3) 60))))))))))
	(t-exists (?prepare_barb6p0 - (prepare_bar b6 p0)) 
		...
		(t-exists (?finish_barb6p3 - (finish_bar b6 p3)) 
		(and (= (- ?loadh0b6p0 ?prepare_barb6p0) 60)(>= (- ?loadh0b6p1 ?unloadh0b6p1) 10)(<= (- ?loadh0b6p1 ?unloadh0b6p1) 30)(>= (- ?loadh0b6p2 ?unloadh0b6p2) 10)(<= (- ?loadh0b6p2 ?unloadh0b6p2) 30)(= (- ?finish_barb6p3 ?unloadh0b6p3) 60))))))))))
	(t-exists (?prepare_barb7p0 - (prepare_bar b7 p0)) 
		...
		(t-exists (?finish_barb7p3 - (finish_bar b7 p3)) 
		(and (= (- ?loadh0b7p0 ?prepare_barb7p0) 60)(>= (- ?loadh0b7p1 ?unloadh0b7p1) 10)(<= (- ?loadh0b7p1 ?unloadh0b7p1) 30)(>= (- ?loadh0b7p2 ?unloadh0b7p2) 10)(<= (- ?loadh0b7p2 ?unloadh0b7p2) 30)(= (- ?finish_barb7p3 ?unloadh0b7p3) 60))))))))))
	(t-exists (?prepare_barb8p0 - (prepare_bar b8 p0)) 
		...
		(t-exists (?finish_barb8p3 - (finish_bar b8 p3)) 
		(and (= (- ?loadh0b8p0 ?prepare_barb8p0) 60)(>= (- ?loadh0b8p1 ?unloadh0b8p1) 10)(<= (- ?loadh0b8p1 ?unloadh0b8p1) 30)(>= (- ?loadh0b8p2 ?unloadh0b8p2) 10)(<= (- ?loadh0b8p2 ?unloadh0b8p2) 30)(= (- ?finish_barb8p3 ?unloadh0b8p3) 60))))))))))
	(t-exists (?prepare_barb9p0 - (prepare_bar b9 p0)) 
		...
		(t-exists (?finish_barb9p3 - (finish_bar b9 p3)) 
		(and (= (- ?loadh0b9p0 ?prepare_barb9p0) 60)(>= (- ?loadh0b9p1 ?unloadh0b9p1) 10)(<= (- ?loadh0b9p1 ?unloadh0b9p1) 30)(>= (- ?loadh0b9p2 ?unloadh0b9p2) 10)(<= (- ?loadh0b9p2 ?unloadh0b9p2) 30)(= (- ?finish_barb9p3 ?unloadh0b9p3) 60))))))))))
