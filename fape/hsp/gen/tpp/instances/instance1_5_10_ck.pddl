(define (control-knowledge ck1) (:domain mais) (:problem p1)
	...
	(t-exists (?prepare_barb4p0 - (prepare_bar b4 p0)) 
		...
		(t-exists (?finish_barb4p4 - (finish_bar b4 p4)) 
		(and (= (- ?loadh0b4p0 ?prepare_barb4p0) 60)(>= (- ?loadh0b4p1 ?unloadh0b4p1) 10)(<= (- ?loadh0b4p1 ?unloadh0b4p1) 30)(>= (- ?loadh0b4p2 ?unloadh0b4p2) 10)(<= (- ?loadh0b4p2 ?unloadh0b4p2) 30)(>= (- ?loadh0b4p3 ?unloadh0b4p3) 10)(<= (- ?loadh0b4p3 ?unloadh0b4p3) 30)(= (- ?finish_barb4p4 ?unloadh0b4p4) 60))))))))))))
	(t-exists (?prepare_barb5p0 - (prepare_bar b5 p0)) 
		...
		(t-exists (?finish_barb5p4 - (finish_bar b5 p4)) 
		(and (= (- ?loadh0b5p0 ?prepare_barb5p0) 60)(>= (- ?loadh0b5p1 ?unloadh0b5p1) 10)(<= (- ?loadh0b5p1 ?unloadh0b5p1) 30)(>= (- ?loadh0b5p2 ?unloadh0b5p2) 10)(<= (- ?loadh0b5p2 ?unloadh0b5p2) 30)(>= (- ?loadh0b5p3 ?unloadh0b5p3) 10)(<= (- ?loadh0b5p3 ?unloadh0b5p3) 30)(= (- ?finish_barb5p4 ?unloadh0b5p4) 60))))))))))))
	(t-exists (?prepare_barb6p0 - (prepare_bar b6 p0)) 
		...
		(t-exists (?finish_barb6p4 - (finish_bar b6 p4)) 
		(and (= (- ?loadh0b6p0 ?prepare_barb6p0) 60)(>= (- ?loadh0b6p1 ?unloadh0b6p1) 10)(<= (- ?loadh0b6p1 ?unloadh0b6p1) 30)(>= (- ?loadh0b6p2 ?unloadh0b6p2) 10)(<= (- ?loadh0b6p2 ?unloadh0b6p2) 30)(>= (- ?loadh0b6p3 ?unloadh0b6p3) 10)(<= (- ?loadh0b6p3 ?unloadh0b6p3) 30)(= (- ?finish_barb6p4 ?unloadh0b6p4) 60))))))))))))
	(t-exists (?prepare_barb7p0 - (prepare_bar b7 p0)) 
		...
		(t-exists (?finish_barb7p4 - (finish_bar b7 p4)) 
		(and (= (- ?loadh0b7p0 ?prepare_barb7p0) 60)(>= (- ?loadh0b7p1 ?unloadh0b7p1) 10)(<= (- ?loadh0b7p1 ?unloadh0b7p1) 30)(>= (- ?loadh0b7p2 ?unloadh0b7p2) 10)(<= (- ?loadh0b7p2 ?unloadh0b7p2) 30)(>= (- ?loadh0b7p3 ?unloadh0b7p3) 10)(<= (- ?loadh0b7p3 ?unloadh0b7p3) 30)(= (- ?finish_barb7p4 ?unloadh0b7p4) 60))))))))))))
	(t-exists (?prepare_barb8p0 - (prepare_bar b8 p0)) 
		...
		(t-exists (?finish_barb8p4 - (finish_bar b8 p4)) 
		(and (= (- ?loadh0b8p0 ?prepare_barb8p0) 60)(>= (- ?loadh0b8p1 ?unloadh0b8p1) 10)(<= (- ?loadh0b8p1 ?unloadh0b8p1) 30)(>= (- ?loadh0b8p2 ?unloadh0b8p2) 10)(<= (- ?loadh0b8p2 ?unloadh0b8p2) 30)(>= (- ?loadh0b8p3 ?unloadh0b8p3) 10)(<= (- ?loadh0b8p3 ?unloadh0b8p3) 30)(= (- ?finish_barb8p4 ?unloadh0b8p4) 60))))))))))))
	(t-exists (?prepare_barb9p0 - (prepare_bar b9 p0)) 
		...
		(t-exists (?finish_barb9p4 - (finish_bar b9 p4)) 
		(and (= (- ?loadh0b9p0 ?prepare_barb9p0) 60)(>= (- ?loadh0b9p1 ?unloadh0b9p1) 10)(<= (- ?loadh0b9p1 ?unloadh0b9p1) 30)(>= (- ?loadh0b9p2 ?unloadh0b9p2) 10)(<= (- ?loadh0b9p2 ?unloadh0b9p2) 30)(>= (- ?loadh0b9p3 ?unloadh0b9p3) 10)(<= (- ?loadh0b9p3 ?unloadh0b9p3) 30)(= (- ?finish_barb9p4 ?unloadh0b9p4) 60))))))))))))
