(define (control-knowledge ck1) (:domain mais) (:problem p1)
	...
	(t-exists (?prepare_barb6p0 - (prepare_bar b6 p0)) 
		...
		(t-exists (?finish_barb6p2 - (finish_bar b6 p2)) 
		(and (= (- ?loadh0b6p0 ?prepare_barb6p0) 60)(>= (- ?loadh0b6p1 ?unloadh0b6p1) 10)(<= (- ?loadh0b6p1 ?unloadh0b6p1) 30)(= (- ?finish_barb6p2 ?unloadh0b6p2) 60))))))))
	(t-exists (?prepare_barb7p0 - (prepare_bar b7 p0)) 
		...
		(t-exists (?finish_barb7p2 - (finish_bar b7 p2)) 
		(and (= (- ?loadh0b7p0 ?prepare_barb7p0) 60)(>= (- ?loadh0b7p1 ?unloadh0b7p1) 10)(<= (- ?loadh0b7p1 ?unloadh0b7p1) 30)(= (- ?finish_barb7p2 ?unloadh0b7p2) 60))))))))
	(t-exists (?prepare_barb8p0 - (prepare_bar b8 p0)) 
		...
		(t-exists (?finish_barb8p2 - (finish_bar b8 p2)) 
		(and (= (- ?loadh0b8p0 ?prepare_barb8p0) 60)(>= (- ?loadh0b8p1 ?unloadh0b8p1) 10)(<= (- ?loadh0b8p1 ?unloadh0b8p1) 30)(= (- ?finish_barb8p2 ?unloadh0b8p2) 60))))))))
	(t-exists (?prepare_barb9p0 - (prepare_bar b9 p0)) 
		...
		(t-exists (?finish_barb9p2 - (finish_bar b9 p2)) 
		(and (= (- ?loadh0b9p0 ?prepare_barb9p0) 60)(>= (- ?loadh0b9p1 ?unloadh0b9p1) 10)(<= (- ?loadh0b9p1 ?unloadh0b9p1) 30)(= (- ?finish_barb9p2 ?unloadh0b9p2) 60))))))))
